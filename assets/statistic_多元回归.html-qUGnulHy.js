import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as t,e as a}from"./app-XqA98pG8.js";const i={},e=a(`<h1 id="多元回归" tabindex="-1"><a class="header-anchor" href="#多元回归" aria-hidden="true">#</a> 多元回归</h1><p>让预测销售额的模型包含湿度, 温度, 天气(晴或雨), 价格4个解释变量. 天气为分类变量, 其余为连续变量.</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token triple-quoted-string string">&quot;&quot;&quot;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>不包含湿度的AIC更小, 所以湿度不应该包含在销售额预测的模型中.</p>`,16),l=[e];function d(u,c){return s(),t("div",null,l)}const o=n(i,[["render",d],["__file","statistic_多元回归.html.vue"]]);export{o as default};
