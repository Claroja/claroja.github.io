import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as a,e as t}from"./app-SnI5rGHA.js";const e={},p=t(`<h1 id="img" tabindex="-1"><a class="header-anchor" href="#img" aria-hidden="true">#</a> img</h1><p>selenium下载图片</p><h2 id="截图" tabindex="-1"><a class="header-anchor" href="#截图" aria-hidden="true">#</a> 截图</h2><p>img.screenshot(&quot;xxx.png&quot;)</p><h3 id="如果图片重叠可以考虑" tabindex="-1"><a class="header-anchor" href="#如果图片重叠可以考虑" aria-hidden="true">#</a> 如果图片重叠可以考虑</h3><p>将</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code>driver<span class="token punctuation">.</span>execute_script<span class="token punctuation">(</span><span class="token triple-quoted-string string">&quot;&quot;&quot;
