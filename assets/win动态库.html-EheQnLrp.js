import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as n,c as i,e as d}from"./app-jdLxCr9I.js";const l={},s=d(`<p>1.创建头文件<code>mydll.h</code></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>#pragma once
...
lib.myadd(10,20)
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,13),t=[s];function a(r,c){return n(),i("div",null,t)}const v=e(l,[["render",a],["__file","win动态库.html.vue"]]);export{v as default};
