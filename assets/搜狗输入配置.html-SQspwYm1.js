import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as i,c as e,e as d}from"./app-jdLxCr9I.js";const s={},l=d(`<h1 id="搜狗输入配置" tabindex="-1"><a class="header-anchor" href="#搜狗输入配置" aria-hidden="true">#</a> 搜狗输入配置</h1><h2 id="自定义短语" tabindex="-1"><a class="header-anchor" href="#自定义短语" aria-hidden="true">#</a> 自定义短语</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>;  搜狗输入法--自定义短语配置文件
