import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as i,c as d,a as n}from"./app-nD1Z-e8V.js";const a={},s=n(`<h1 id="pull" tabindex="-1"><a class="header-anchor" href="#pull" aria-hidden="true">#</a> pull</h1><p><code>git pull</code> is shorthand for <code>git fetch</code> followed by <code>git merge</code> FETCH_HEAD.</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>git pull [host] [branch]
...
D---E---F---G---H master
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,12),l=[s];function r(o,c){return i(),d("div",null,l)}const u=e(a,[["render",r],["__file","pull.html.vue"]]);export{u as default};
