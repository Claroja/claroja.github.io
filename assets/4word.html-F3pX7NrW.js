import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as a,e}from"./app-A10JnHE0.js";const o="/assets/word样式修改-Qio7s_6P.png",t={},i=e(`<h1 id="pandoc模板" tabindex="-1"><a class="header-anchor" href="#pandoc模板" aria-hidden="true">#</a> pandoc模板</h1><h2 id="最佳实践" tabindex="-1"><a class="header-anchor" href="#最佳实践" aria-hidden="true">#</a> 最佳实践</h2><ol><li><p>在<code>vscode</code>根目录的<code>.vscode</code>文件夹下, 创建<code>tasks.json</code></p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>
