import{_ as i}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as n,c as e,a as d}from"./app-nD1Z-e8V.js";const s={},l=d(`<h2 id="隐式转换-自动转换" tabindex="-1"><a class="header-anchor" href="#隐式转换-自动转换" aria-hidden="true">#</a> 隐式转换(自动转换)</h2><p>遵循一定的规则,由编译系统自动完成</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>#include &lt;stdio.h&gt;
