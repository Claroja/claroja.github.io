import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as n,e as i}from"./app-A10JnHE0.js";const a={},t=i(`<h1 id="script" tabindex="-1"><a class="header-anchor" href="#script" aria-hidden="true">#</a> script</h1><p>setup script 是vue3的一个新的语法糖。只需要在script标签中加上setup 关键字。</p><div class="language-htm line-numbers-mode" data-ext="htm"><pre class="language-htm"><code>&lt;script setup&gt;
    export default {
        ...
    }
&lt;/script&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="参考" tabindex="-1"><a class="header-anchor" href="#参考" aria-hidden="true">#</a> 参考:</h2><ol><li>https://v3.vuejs.org/api/sfc-script-setup.html#typescript-only-features</li><li>https://www.cnblogs.com/goloving/p/15437343.html</li></ol>`,17),l=[t];function d(r,c){return s(),n("div",null,l)}const o=e(a,[["render",d],["__file","3_2setupScript.html.vue"]]);export{o as default};
