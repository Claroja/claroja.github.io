...
├── _config.yml      #博客配置
└── package.json     #应用程序数据
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2);function N(V,y){const l=o("ExternalLinkIcon");return t(),d("div",null,[r,h,e("ol",_,[u,v,e("li",null,[n("下载"),m,n(", "),e("a",x,[n("官网"),s(l)]),n(", 并配置环境变量")]),e("li",null,[n("安装"),b,n("类似于一个可执行文件, "),e("a",p,[n("官网"),s(l)]),n("看. "),f]),g,k]),j])}const I=i(c,[["render",N],["__file","安装.html.vue"]]);export{I as default};
