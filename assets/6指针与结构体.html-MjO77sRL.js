import{_ as i}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as n,c as e,e as d}from"./app-A10JnHE0.js";const t={},s=d(`<h1 id="结构体指针" tabindex="-1"><a class="header-anchor" href="#结构体指针" aria-hidden="true">#</a> 结构体指针</h1><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code># include &lt;stdio.h&gt;//引用函数库
# include &lt;stdlib.h&gt;
struct info{
	char name[4];
	int age;
