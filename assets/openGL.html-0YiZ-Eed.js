import{_ as p}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as e,c as t,e as a,a as n,b as s}from"./app-MTzDpLgJ.js";const o={},l=a(`<h1 id="离散-期望" tabindex="-1"><a class="header-anchor" href="#离散-期望" aria-hidden="true">#</a> 离散_期望</h1><h2 id="设置窗口" tabindex="-1"><a class="header-anchor" href="#设置窗口" aria-hidden="true">#</a> 设置窗口</h2><h2 id="点" tabindex="-1"><a class="header-anchor" href="#点" aria-hidden="true">#</a> 点</h2><p>所有的电脑图像都是2维的. 最基础的是画点(points or pixels), 设置大小(size)和颜色(color)</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">from</span> OpenGL<span class="token punctuation">.</span>GL <span class="token keyword">import</span> <span class="token operator">*</span>
