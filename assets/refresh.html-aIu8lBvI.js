import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as a,e}from"./app-yeyEmHfz.js";const t={},i=e(`<h1 id="refresh" tabindex="-1"><a class="header-anchor" href="#refresh" aria-hidden="true">#</a> refresh</h1><p>refresh token的作用是刷新access token. 因为一直使用同一个access token在网络中传输, 可能会被截获. 偶尔使用一次refresh token会降低风险. access_token只能用于携带访问，并不能用于刷新token；同理refresh_token只能用于刷新，不能用于访问数据。</p><h2 id="服务端代码" tabindex="-1"><a class="header-anchor" href="#服务端代码" aria-hidden="true">#</a> 服务端代码</h2><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">from</span> flask_jwt_extended <span class="token keyword">import</span> create_access_token
