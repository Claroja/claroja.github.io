import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as e,e as a}from"./app-A10JnHE0.js";const t={},o=a(`<h1 id="traceback" tabindex="-1"><a class="header-anchor" href="#traceback" aria-hidden="true">#</a> traceback</h1><p><code>python</code>会在抛出<code>exceptions</code>时打印<code>traceback</code>, 来帮助你查找出错的地方.</p><p>创建以下代码, 可以看到形参是<code>someone</code>, 而在函数里面, 我们写成了<code>someon</code>, 所以在调用的时候会报错.</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">def</span> <span class="token function">greet</span><span class="token punctuation">(</span>someone<span class="token punctuation">)</span><span class="token punctuation">:</span>
