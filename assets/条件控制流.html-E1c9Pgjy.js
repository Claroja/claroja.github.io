import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as a,e}from"./app-SnI5rGHA.js";const p={},t=e(`<h1 id="条件控制流" tabindex="-1"><a class="header-anchor" href="#条件控制流" aria-hidden="true">#</a> 条件控制流</h1><h2 id="if条件" tabindex="-1"><a class="header-anchor" href="#if条件" aria-hidden="true">#</a> if条件</h2><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">if</span> <span class="token punctuation">(</span>条件表达式<span class="token number">1</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
