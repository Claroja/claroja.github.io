import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as a,e}from"./app-SnI5rGHA.js";const t={},p=e(`<h1 id="reflection" tabindex="-1"><a class="header-anchor" href="#reflection" aria-hidden="true">#</a> reflection</h1><h2 id="get-instance-object" tabindex="-1"><a class="header-anchor" href="#get-instance-object" aria-hidden="true">#</a> get instance object</h2><p>in definition, we can get instance object by <code>self</code></p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">class</span> <span class="token class-name">test</span><span class="token punctuation">(</span><span class="token builtin">object</span><span class="token punctuation">)</span><span class="token punctuation">:</span>
