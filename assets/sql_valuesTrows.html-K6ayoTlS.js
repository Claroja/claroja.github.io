import{_ as s}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as n,c as a,d as e}from"./app-j3zK2x6_.js";const t={},l=e(`<h1 id="valuestrows" tabindex="-1"><a class="header-anchor" href="#valuestrows" aria-hidden="true">#</a> valuesTrows</h1><div class="language-data line-numbers-mode" data-ext="data"><pre class="language-data"><code>id | name    
1  | a,b,c    
2  | b
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>refs: https://stackoverflow.com/questions/17942508/sql-split-values-to-multiple-rows https://stackoverflow.com/questions/276927/can-i-concatenate-multiple-mysql-rows-into-one-field</p>`,8),i=[l];function o(c,d){return n(),a("div",null,i)}const u=s(t,[["render",o],["__file","sql_valuesTrows.html.vue"]]);export{u as default};
