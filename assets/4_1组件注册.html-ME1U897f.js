import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as e,c as s,a as t}from"./app-9tftCahk.js";const a={},i=t(`<h1 id="_1组间基础component" tabindex="-1"><a class="header-anchor" href="#_1组间基础component" aria-hidden="true">#</a> 1组间基础component</h1><h2 id="定义组件" tabindex="-1"><a class="header-anchor" href="#定义组件" aria-hidden="true">#</a> 定义组件</h2><p>创建<code>.vue</code>文件, 文件分为3个部分<code>template</code>(用于写html), <code>script</code>(用来写vue的属性), <code>style</code>(用来写样式)</p><div class="language-htm line-numbers-mode" data-ext="htm"><pre class="language-htm"><code>&lt;script setup&gt;
	import { ref } from &#39;vue&#39;
	const count = ref(0)
&lt;/script&gt;
