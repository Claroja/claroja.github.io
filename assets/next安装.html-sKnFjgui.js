import{_ as i}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as t,o as l,c,a as n,b as s,d as a,e as o}from"./app-O0xqlHfm.js";const r={},d=n("h1",{id:"next安装",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#next安装","aria-hidden":"true"},"#"),s(" next安装")],-1),p={href:"https://github.com/next-theme",target:"_blank",rel:"noopener noreferrer"},u=n("h2",{id:"安装",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#安装","aria-hidden":"true"},"#"),s(" 安装")],-1),v={href:"https://theme-next.js.org/docs/getting-started/#Hexo-Installation",target:"_blank",rel:"noopener noreferrer"},m={href:"https://theme-next.js.org/docs/third-party-services/math-equations.html",target:"_blank",rel:"noopener noreferrer"},b=o(`<h2 id="next主题的目录结构" tabindex="-1"><a class="header-anchor" href="#next主题的目录结构" aria-hidden="true">#</a> next主题的目录结构</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>├── .github                #github信息
├── languages              #多语言
|   ├── _en.yml            #默认语言
|   └── zh-CN.yml          #简体中文
|   └── zh-TW.yml          #繁体中文
