import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as a,e}from"./app-jdLxCr9I.js";const t={},l=e(`<h1 id="第一编总则-第六章证据" tabindex="-1"><a class="header-anchor" href="#第一编总则-第六章证据" aria-hidden="true">#</a> 第一编总则_第六章证据</h1><h2 id="job-一次性任务" tabindex="-1"><a class="header-anchor" href="#job-一次性任务" aria-hidden="true">#</a> Job 一次性任务</h2><p>执行一次就停止</p><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">apiVersion</span><span class="token punctuation">:</span> batch/v1
