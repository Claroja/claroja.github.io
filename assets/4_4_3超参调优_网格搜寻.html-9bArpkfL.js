import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as a,e}from"./app-jdLxCr9I.js";const t={},p=e(`<h1 id="超参调优-网格搜索" tabindex="-1"><a class="header-anchor" href="#超参调优-网格搜索" aria-hidden="true">#</a> 超参调优_网格搜索</h1><h2 id="接口" tabindex="-1"><a class="header-anchor" href="#接口" aria-hidden="true">#</a> 接口</h2><h3 id="构造参数" tabindex="-1"><a class="header-anchor" href="#构造参数" aria-hidden="true">#</a> 构造参数</h3><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code>GridSearchCV<span class="token punctuation">(</span>
