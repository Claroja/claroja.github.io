import{_ as o}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as p,o as l,c as i,b as n,d as a,e as t,a as s}from"./app-9tftCahk.js";const c={},r=s(`<h1 id="安装配置" tabindex="-1"><a class="header-anchor" href="#安装配置" aria-hidden="true">#</a> 安装配置</h1><h2 id="最佳实践" tabindex="-1"><a class="header-anchor" href="#最佳实践" aria-hidden="true">#</a> 最佳实践</h2><p>配置基础配置</p><ol><li>让项目在浏览器中自动打开</li></ol><p>修改page.json文件中的&quot;serve&quot;, 加上<code>--open</code>即可</p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token property">&quot;scripts&quot;</span><span class="token operator">:</span> <span class="token punctuation">{</span>
