...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="最终效果" tabindex="-1"><a class="header-anchor" href="#最终效果" aria-hidden="true">#</a> 最终效果</h2><p>这种样式配合<code>&lt;--more--&gt;</code>摘要,可以将首页文章展示做小,而不是展示文章所有内容.</p><p><a href="./next%E6%9F%A5%E7%9C%8B%E6%9B%B4%E5%A4%9A%E5%8A%9F%E8%83%BD/2.png"></a></p>`,8);function m(v,k){const e=o("ExternalLinkIcon");return l(),i("div",null,[r,n("p",null,[s("用来配置自定义的js和样式等,详细参考"),n("a",d,[s("官网"),c(e)])]),u])}const _=t(p,[["render",m],["__file","next查看更多功能.html.vue"]]);export{_ as default};
