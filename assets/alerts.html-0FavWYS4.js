import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as a,c as s,e}from"./app-0JgdiRQ-.js";const t={},i=e(`<h1 id="alerts" tabindex="-1"><a class="header-anchor" href="#alerts" aria-hidden="true">#</a> alerts</h1><h2 id="alerts-1" tabindex="-1"><a class="header-anchor" href="#alerts-1" aria-hidden="true">#</a> Alerts</h2><p>仅有一个按键的alert</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment">## Click the link to activate the alert</span>
