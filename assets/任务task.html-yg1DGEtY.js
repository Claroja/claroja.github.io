import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as a,e as o}from"./app-A10JnHE0.js";const t={},e=o(`<h1 id="任务" tabindex="-1"><a class="header-anchor" href="#任务" aria-hidden="true">#</a> 任务</h1><h2 id="最佳实践" tabindex="-1"><a class="header-anchor" href="#最佳实践" aria-hidden="true">#</a> 最佳实践</h2><p>使用task, 简化pandoc命令操作:</p><ol><li>简化前, 每次md转docx都需要手动输入命令, 复制文件名</li><li>简化后, 只需选中md文件, 使用快捷键alt+shift+r执行如下的task即可</li></ol><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>
