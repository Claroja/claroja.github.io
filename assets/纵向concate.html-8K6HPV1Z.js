import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as a,e as t}from"./app-A10JnHE0.js";const p={},e=t(`<h1 id="合并数据集-纵向concate" tabindex="-1"><a class="header-anchor" href="#合并数据集-纵向concate" aria-hidden="true">#</a> 合并数据集_纵向concate</h1><h2 id="参数解释" tabindex="-1"><a class="header-anchor" href="#参数解释" aria-hidden="true">#</a> 参数解释</h2><h3 id="测试数据集" tabindex="-1"><a class="header-anchor" href="#测试数据集" aria-hidden="true">#</a> 测试数据集</h3><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code>df1 <span class="token operator">=</span> pd<span class="token punctuation">.</span>DataFrame<span class="token punctuation">(</span>
