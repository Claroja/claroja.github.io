import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as a,e as p}from"./app-M6UUlHgF.js";const e="/assets/1-nAaYwP_6.png",t={},c=p(`<h1 id="pywin32api" tabindex="-1"><a class="header-anchor" href="#pywin32api" aria-hidden="true">#</a> pywin32api</h1><p>win32api模块主要用来控制:</p><ol><li>鼠标</li><li>键盘</li></ol><h2 id="鼠标" tabindex="-1"><a class="header-anchor" href="#鼠标" aria-hidden="true">#</a> 鼠标</h2><p>鼠标的控制分为两个:</p><ol><li>移动, 使用<code>SetCursorPos</code>方法</li><li>点击, 使用<code>mouse_event</code>, 然后在第一个参数输入按键值</li></ol><h3 id="移动鼠标" tabindex="-1"><a class="header-anchor" href="#移动鼠标" aria-hidden="true">#</a> 移动鼠标</h3><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">import</span> win32api<span class="token punctuation">,</span>win32con
