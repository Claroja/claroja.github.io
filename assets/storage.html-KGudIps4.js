import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as a,e}from"./app-M6UUlHgF.js";const t={},o=e(`<h1 id="storage" tabindex="-1"><a class="header-anchor" href="#storage" aria-hidden="true">#</a> storage</h1><p><code>tensor</code>由头信息区(<code>Tensor</code>)和存储区(<code>Storage</code>).</p><ul><li>头信息区主要保存着<code>Tensor</code>的形状(size),步长(stride),数据类型(type)等信息</li><li>存储区则保存真正的数据, 是连续的数组</li></ul><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">import</span> torch
