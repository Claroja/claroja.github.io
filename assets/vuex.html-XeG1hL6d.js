import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as a,e as t}from"./app-qxiCM96p.js";const p={},e=t(`<h1 id="vuex" tabindex="-1"><a class="header-anchor" href="#vuex" aria-hidden="true">#</a> vuex</h1><h2 id="基础" tabindex="-1"><a class="header-anchor" href="#基础" aria-hidden="true">#</a> 基础</h2><ol><li><p>vuex为不同的组件提供公共的数据存储</p></li><li><p>两个个重要概念:</p><ol><li>首先dispatch到Actions(服务员,先对数据做处理)</li><li>然后commit到Mutations(厨子, 直接操作数据, state) 可参考官网:https://vuex.vuejs.org/zh/</li></ol></li><li><p>Vue.use() 用来添加插件, 这样就可以在new Vue()中增加键</p></li><li><p>export 要使用{} export default 不需要,default作用</p></li><li><p>无论<code>import</code>在哪 都是先执行</p></li></ol><h2 id="样例" tabindex="-1"><a class="header-anchor" href="#样例" aria-hidden="true">#</a> 样例</h2><ol><li>首先给Vue插入Vuex插件</li><li>准备Vuex.store 将state, actions, mutations组合成Vuex.Store</li><li>在Vue实例中挂载store</li></ol><div class="language-html line-numbers-mode" data-ext="html"><pre class="language-html"><code><span class="token doctype"><span class="token punctuation">&lt;!</span><span class="token doctype-tag">DOCTYPE</span> <span class="token name">html</span><span class="token punctuation">&gt;</span></span>
