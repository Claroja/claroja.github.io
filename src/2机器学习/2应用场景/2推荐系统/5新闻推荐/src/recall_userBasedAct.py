...
from tools_recall import get_item_simEmb_dict, get_all_click_df, get_item_info_df, get_item_emb_dict, get_item_info_dict, get_hist_and_last_click, get_item_topk_click_list,  get_item_simAct_dict, get_item_user_time_dict, get_user_activate_degree_dict, metrics_recall, user_based_recommend, get_user_simAct_dict,get_user_item_time_dict
...
user_simAct_dict = get_user_simAct_dict(item_user_time_dict, user_activate_degree_dict)
...
userBasedAct_recall_dict = collections.defaultdict(dict)
for user in tqdm(trn_hist_click_df['user_id'].unique()):
    userBasedAct_recall_dict[user] = user_based_recommend(user, user_item_time_dict, user_simAct_dict, sim_user_topk, recall_item_num, item_topk_click, item_created_time_dict, item_simEmb_dict)    

metrics_recall(userBasedAct_recall_dict, trn_last_click_df, topk=recall_item_num)
pickle.dump(userBasedAct_recall_dict, open(MIDPATH + 'userBasedAct_recall_dict.pkl', 'wb'))